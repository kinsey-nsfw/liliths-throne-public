	...
	public static final DialogueNode CONTENT_PREFERENCE = new DialogueNode("Content Options", "", true) {
		...
		public String getHeaderContent(){
			...
			UtilText.nodeContentSB.append(getContentPreferenceDiv(
							...
							Colour.BASE_ORANGE,
							"Rimming Content",
							"When disabled, removes all rimming-related (anal/tongue contact) actions from being available during sex. "
							+ "<br>If anal content is already disabled, removes ass/mouth contact actions.",
							Main.getProperties().hasValue(PropertyValue.rimmingContent)));
